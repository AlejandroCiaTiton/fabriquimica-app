            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-100">
                  ...
                  <th className="text-left px-4 py-3 font-medium text-gray-500 w-28">Fecha OC</th>
                  ...
                  <th className="text-center px-4 py-3 font-medium text-gray-500 w-28">Pago</th>
                  <th className="text-center px-4 py-3 font-medium text-gray-500 w-28">Recepción</th>
                  <th className="text-center px-4 py-3 font-medium text-gray-500 w-14">PDF</th>
                </tr>
              </thead>
                ...
                {completadas.map(oc => {
                  ...
                  return (
                    <tr key={oc.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-gray-500">{new Date(oc.creado_en).toLocaleDateString('es-AR')}</td>
                      <td className="px-4 py-3 text-gray-500 text-xs">{oc.numero_factura ?? <span className="text-gray-300">—</span>}</td>
