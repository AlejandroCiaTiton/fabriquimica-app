    ...
    <div className={`rounded-xl border ${c.border} ${c.bg} p-4`}>
      <div className="flex items-start justify-between gap-3 mb-3">
        ...
        {url && (
          <a href={url} target="_blank" rel="noopener noreferrer"
            className="flex-shrink-0 text-xs font-medium text-[#1b4332] hover:underline flex items-center gap-1">
      ...
      <label className={`flex items-center gap-2 cursor-pointer w-fit text-xs font-medium px-3 py-1.5 rounded-lg border transition-colors ${
        uploading
          ...
          : 'border-gray-300 text-gray-600 hover:border-[#1b4332] hover:text-[#1b4332] bg-white'
      }`}>
            ...
            <>
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button onClick={guardar} disabled={actualizar.isPending}
                  className="flex-1 bg-[#1b4332] hover:bg-[#152e24] text-white font-medium py-2 rounded-lg text-sm transition-colors disabled:opacity-60 flex items-center justify-center gap-2">
