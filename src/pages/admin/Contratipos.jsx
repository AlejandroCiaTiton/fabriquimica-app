...
function useContratipos() {
  return useQuery({
    queryKey: ['admin', 'contratipos'],
    queryFn: async () => {
  ...
  return new Promise((resolve, reject) => {
    ...
    reader.onload = e => {
      try {
        ...
        // Detect delimiter for CSV files (Spanish Excel exports use ';')
        ...
        // Normalize key: lowercase, remove everything except a-z and 0-9
        ...
        const parsed = rows
          .map(r => ({
            // 'NOMBRE FABRIQUIMICA' → 'nombrefabriquimica', also accepts nombre_fq, fq, etc.
            nombre_fq: col(r,
              'nombre fabriquimica', 'nombre_fabriquimica', 'nombrefabriquimica',
              'nombre_fq', 'nombrefq', 'fq',
              'nombre fq', 'producto fq', 'productofq',
            ),
            marca: col(r,
              'marca', 'nombre comercial', 'nombrecomercial',
              'nombre marca', 'nombredemarca', 'product name',
            ),
            productor: col(r,
              'productor', 'fabricante', 'manufacturer', 'producer', 'empresa',
            ),
          }))
...
export default function Contratipos() {
