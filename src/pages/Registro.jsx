...
const CAMPO = 'w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#004a99] focus:border-transparent'
    ...
    return (
      <div className="min-h-screen bg-[#f0f4f8] flex items-center justify-center p-4">
        <div className="bg-white rounded-[10px] shadow-md w-full max-w-md p-8 text-center">
          ...
          <Link to="/login" className="text-[#004a99] text-sm font-medium hover:underline">← Volver al inicio de sesión</Link>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-[#f0f4f8] py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <Link to="/login" className="text-sm text-gray-500 hover:text-[#004a99] flex items-center gap-1">
            ...
            <div className="space-y-5">
              ...
              <div className="bg-white rounded-[10px] shadow-sm p-6">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3 p-3 bg-[#f0f4f8] rounded-lg">
                      <div className="w-7 h-7 rounded-full bg-[#004a99] text-white font-bold text-xs flex items-center justify-center flex-shrink-0 mt-0.5">
                        {i + 1}
                      </div>
                      <div>
                ...
                <button type="submit" disabled={loading}
                  className="mt-5 w-full bg-[#004a99] hover:bg-[#003d80] text-white font-medium py-2.5 rounded-lg transition-colors disabled:opacity-60 flex items-center justify-center gap-2">
                  {loading
